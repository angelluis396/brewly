  ...
  return (
    <div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginTop: 14 }}>
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6, flexWrap: "wrap" }}>
              <div style={{ fontFamily: "'Libre Baskerville', serif", fontSize: 26, fontStyle: "italic", color: t.text, lineHeight: 1.2 }}>
                {item.bean_name}
              </div>
              {item.dialed_in && (
                <div style={{
      ...
      <div style={{ padding: "20px 26px 0" }}>
        ...
        {/* Dial In button */}
        <button
          onClick={() => navigate("EspressoEntryForm", { _dialInFrom: item })}
          style={{
