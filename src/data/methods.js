export const METHODS = [
  ...
  },
  {
    ...
    specs_ml: [
      ...
      { name: "Heat level", val: "Medium low" }, { name: "Brew ratiåo", val: "1:7" }, { name: "Brew time", val: "4–5 min" },
    ],
    specs_oz: [
      { name: "Coffee dose", val: "0.5 oz" }, { name: "Water", åval: "3 oz" },
  ...
  {
    id: 6, name: "AeroPress", label: "Pressure Steep", brewType: "Immersion",
    time: "2 min", brewTime: "2 min", temp: "80°C", ratio: "1:16", yield_ml: 240, yield_oz: 8,
    grindPos: 3, grindLabel: "Medium-Fine",
    tags: ["Beginner", "Versatile", "Quick"],
    ...
    specs_ml: [
      { name: "Coffee dose", val: "15g" }, { name: "Water", val: "240ml" },
      { name: "Water temp", val: "80°C / 176°F" }, { name: "Brew ratio", val: "1:16" }, { name: "Brew time", val: "2 min" },
    ],
    specs_oz: [
      { name: "Coffee dose", val: "0.5 oz" }, { name: "Water", val: "8 oz" },
      { name: "Water temp", val: "80°C / 176°F" }, { name: "Brew ratio", val: "1:16" }, { name: "Brew time", val: "2 min" },
    ],
    steps: [
      { title: "Set up & rinse", desc: "Place a paper filter in the cap and rinse with hot water. Attach cap and set AeroPress on your mug." },
      { title: "Add coffee & water", desc: "Add 15g of medium-fine ground coffee. Pour 240ml of 80°C water and stir gently for 10 seconds." },
      { title: "Steep", desc: "Place the plunger on top to create a seal. Steep for 1 minute." },
      { title: "Press", desc: "Press down slowly and steadily over 30 seconds. Stop when you hear a hiss — do not force it." },
    ],
    tip: "Lower water temp than espresso means less bitterness. Try the inverted method for a longer, more immersive steep. AeroPress is one of the most forgiving and versatile brewers out there.",
  },
  {
    id: 7, name: "Automatic Drip", label: "Drip Machine", brewType: "Percolation",
    time: "5–8 min", brewTime: "5–8 min", temp: "93°C", ratio: "1:15", yield_ml: 600, yield_oz: 20,
    grindPos: 4, grindLabel: "Medium",
    tags: ["Beginner", "Easy", "High volume"],
    ...
    specs_ml: [
      { name: "Coffee dose", val: "40g" }, { name: "Water", val: "600ml" },
      { name: "Water temp", val: "93°C / 200°F" }, { name: "Brew ratio", val: "1:15" }, { name: "Brew time", val: "5–8 min" },
    ],
    specs_oz: [
      { name: "Coffee dose", val: "1.4 oz" }, { name: "Water", val: "20 oz" },
      { name: "Water temp", val: "93°C / 200°F" }, { name: "Brew ratio", val: "1:15" }, { name: "Brew time", val: "5–8 min" },
    ],
    steps: [
      { title: "Clean & set up", desc: "Make sure the carafe and filter basket are clean. Place a paper or reusable filter in the basket." },
      { title: "Add coffee", desc: "Add 40g of medium ground coffee to the filter. Level it out gently — no tamping needed." },
      { title: "Add water & brew", desc: "Fill the reservoir with 600ml of filtered water and start the machine." },
      { title: "Serve promptly", desc: "Pour as soon as brewing finishes. Turn off the hot plate — leaving coffee on heat makes it bitter fast." },
    ],
    tip: "Use filtered water and clean your machine monthly. A dirty machine is the number one reason home drip coffee tastes flat. Most machines also benefit from being preheated with a water-only cycle.",
  },
];
